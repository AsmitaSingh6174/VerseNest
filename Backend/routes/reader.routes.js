...
router.post(
    ...
    [
        ...
        body('genreFocus')
            .notEmpty().withMessage('Genre focus is required')
            .isIn(['Lyrical', 'Narrative', 'Sonnet', 'Haiku', 'Fantasy', 'Free Verse', 'Other'])
            .withMessage('Invalid genre focus'),
        body('moodPreferences')
            .optional()
            .isArray().withMessage('Mood preferences must be an array of strings')
    ],
